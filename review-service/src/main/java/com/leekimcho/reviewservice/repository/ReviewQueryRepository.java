...
import static com.leekimcho.reviewservice.entity.QReview.review;
...
public class ReviewQueryRepository extends QuerydslRepositorySupport {
    ...
    public List<Review> search(String keyword, Long reviewId, int size) {
        return queryFactory
                ...
                .where(
                        ltReviewId(reviewId),
                        review.content.containsIgnoreCase(keyword).or(review.problemTitle.containsIgnoreCase(keyword))
                )
