package com.leekimcho.memberservice.global.security;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.leekimcho.memberservice.domain.jwt.service.RefreshTokenServiceImpl;
import com.leekimcho.memberservice.domain.member.entity.Member;
import com.leekimcho.memberservice.global.dto.LoginRequest;
...
public class LoginAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response, FilterChain chain, Authentication authResult) throws IOException {
        ...
        String accessToken = jwtTokenProvider.createJwtAccessToken(MemberId, request.getRequestURI(), roles);
        Date expiredTime = jwtTokenProvider.getExpiredTime(accessToken);
        String refreshToken = jwtTokenProvider.createJwtRefreshToken();

        refreshTokenServiceImpl.updateRefreshToken(Long.valueOf(MemberId), jwtTokenProvider.getRefreshTokenId(refreshToken));
