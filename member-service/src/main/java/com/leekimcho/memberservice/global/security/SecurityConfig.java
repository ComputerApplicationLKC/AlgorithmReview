...
import com.leekimcho.memberservice.domain.jwt.service.OAuthService;
...
//        http.addFilterBefore(new HeaderAuthorizationFilter(), MembernamePasswordAuthenticationFilter.class);
    }
